$(document).ready(function () {
	...
	$(".add_new_phone_dynamic_responsible_bid_newspaper").on('click', function(e) {
		...
		var $div_phone = $("<div>", {"class": "input tel optional bid_newspaper_responsibles_phones_phone"});
		var id = "bid_newspaper_responsibles_attributes_{x}_phones_attributes_{y}_phone".replace("{x}",position_value).replace("{y}",value_new_object);
		var name = "bid_newspaper[responsibles_attributes][{x}][phones_attributes][{y}][phone]".replace("{x}",position_value).replace("{y}",value_new_object);;
	...
	$(".add_new_email_dynamic_responsible_bid_newspaper").on('click', function(e) {
		var position_value = this.id.split('_')[4]; 
		var value_new_object = $("#emails_counter_responsibles_"+position_value).val();
		var $div_row = $("<div>", {"class": "inline"});

		var $div_email = $("<div>", {"class": "input tel optional bid_newspaper_responsibles_emails_email"});
		var id = "bid_newspaper_responsibles_attributes_{x}_emails_attributes_{y}_email".replace("{x}",position_value).replace("{y}",value_new_object);
		var name = "bid_newspaper[responsibles_attributes][{x}][emails_attributes][{y}][email]".replace("{x}",position_value).replace("{y}",value_new_object);;
	...
	$(".add_new_skype_dynamic_responsible_bid_newspaper").on('click', function(e) {
		var position_value = this.id.split('_')[4]; 
		var value_new_object = $("#skypes_counter_responsibles_"+position_value).val();
		var $div_row = $("<div>", {"class": "inline"});

		var $div_skype = $("<div>", {"class": "input tel optional bid_newspaper_responsibles_skypes_skype"});
		var id = "bid_newspaper_responsibles_attributes_{x}_skypes_attributes_{y}_skype".replace("{x}",position_value).replace("{y}",value_new_object);
		var name = "bid_newspaper[responsibles_attributes][{x}][skypes_attributes][{y}][skype]".replace("{x}",position_value).replace("{y}",value_new_object);;
	...
	$(".edit_bid_newspaper").on('click', '.delete_phone_dynamic', function(e) {
		$(this).parent().remove();
	});

	// Removendo telefone do responsável do diário oficial
	$(".new_bid_newspaper").on('click', '.delete_phone_dynamic', function(e) {
		$(this).parent().remove();
	});

	// Removendo email do responsável do diário oficial
	$(".edit_bid_newspaper").on('click', '.delete_email_dynamic', function(e) {
		$(this).parent().remove();
	});

	// Removendo email do responsável do diário oficial
	$(".new_bid_newspaper").on('click', '.delete_email_dynamic', function(e) {
		$(this).parent().remove();
	});

	// Removendo skype do responsável do diário oficial
	$(".edit_bid_newspaper").on('click', '.delete_skype_dynamic', function(e) {
		$(this).parent().remove();
	});

	// Removendo skype do responsável do diário oficial
	$(".new_bid_newspaper").on('click', '.delete_skype_dynamic', function(e) {
		$(this).parent().remove();
	});
